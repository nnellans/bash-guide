...
> [GSG](https://google.github.io/styleguide/shellguide.html): Put all functions at the top of the file, only preceded by includes, set statements, & declaring constants
